...
public class EmailController {
    ...
    public boolean sendRecipt() {
        ...
        return mock.sendEmail(email, this.makeRecipt());
    }
    ...
    private int getTranscation() {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery(
                "SELECT transaction_id FROM transactions WHERE email = '" +
                this.user + "'" + "ORDER BY transaction_id desc LIMIT 1"
            );
    ...
    private String makeRecipt() {
        ...
        "Hello " + name + " " + lastName + "! The transaction id is " +
        transaction + " on your account " + " with the register email: " + email;
